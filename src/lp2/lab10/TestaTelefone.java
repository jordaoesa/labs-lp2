...
public class TestaTelefone {
	...
	public void testaTipoDeItemContato(){
		Assert.assertEquals("Erro em tipoDeContato()", TipoDeItemDeContato.TELEFONE, telefone.tipoDoContato());
		Assert.assertFalse(TipoDeItemDeContato.EMAIL == telefone.tipoDoContato());
		Assert.assertFalse(TipoDeItemDeContato.ENDERECO == telefone.tipoDoContato());
	}
	
	@Test
	public void testaExibirContato(){
		Assert.assertEquals("Erro em exibirContato()", "Telefone >> 55-83-99999999", telefone.exibirContato());
		...
		Assert.assertEquals("Erro em exibirContato()", "Telefone >> 99-99-99999999", telefone.exibirContato());
	}
	...
	public void testaGetsSets(){
		Assert.assertEquals("Erro em getTelefone()", "55-83-99999999", telefone.getTelefone());
		telefone.setTelefone("12-34-12345678");
		Assert.assertEquals("Erro em getTelefone()", "12-34-12345678", telefone.getTelefone());
	}
