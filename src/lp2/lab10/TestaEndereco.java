...
public class TestaEndereco {
	...
	public void testaEquals(){
		...
		Endereco end = new Endereco(rua, complemento, bairro, cidade, estado, cep,
				numero);
	...
	public void testaGetsSets(){
		Assert.assertEquals("Erro em getBairro()", "Conjunto dos Professores", endereco.getBairro());
		Assert.assertEquals("Erro em getCep()", "12345-000", endereco.getCep());
		Assert.assertEquals("Erro em getCidade()", "Campina Grande", endereco.getCidade());
		Assert.assertEquals("Erro em getComplemento()", "Apartamento", endereco.getComplemento());
		Assert.assertEquals("Erro em getEstado()", "Paraiba", endereco.getEstado());
		Assert.assertEquals("Erro em getNumero()", 1, endereco.getNumero());
		Assert.assertEquals("Erro em getRua()", "Rua Prof Severino", endereco.getRua());
		...
		Assert.assertEquals("Erro em getBairro()", "outro bairro", endereco.getBairro());
		Assert.assertEquals("Erro em getCep()", "22222-000", endereco.getCep());
		Assert.assertEquals("Erro em getCidade()", "outra cidade", endereco.getCidade());
		Assert.assertEquals("Erro em getComplemento()", "outro complemento", endereco.getComplemento());
		Assert.assertEquals("Erro em getEstado()", "outro estado", endereco.getEstado());
